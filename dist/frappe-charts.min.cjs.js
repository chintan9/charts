...
function makePath(t) {
  return createSVG("path", {
    ...
    styles: {
      stroke:
        arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "none",
      fill:
...
function makeHoriLine(t, e, n, i) {
  ...
  return (
    (0 !== s && "0" !== s) || (o.style.stroke = "rgba(27, 31, 35, 0.6)"),
    o.appendChild(r),
    o.appendChild(s),
    o
  );
...
function animateRegion(t, e, n, i) {
  ...
  return [
    [
      r,
      { height: a, "stroke-dasharray": r.getAttribute("width") + ", " + a },
...
function animateSVGElement(t, e, n) {
  var i =
      arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "linear",
...
function calcChartIntervals(t) {
  function e(t, e) {
    for (
      var n = getChartIntervals(t), i = n[1] - n[0], a = 0, r = 1;
      a < e;
      r++
    )
      (a += i), n.unshift(-1 * a);
...
function calcDistribution(t, e) {
  for (
    var n = Math.max.apply(Math, _toConsumableArray$4(t)),
      i = 1 / (e - 1),
      a = [],
      r = 0;
    r < e;
...
var BASE_MEASURES = {
      ...
      _createClass$3(t, [
        ...
        },
        {
          ...
          value: function () {
            ...
            if (this.left < 0)
              (n.style.left = "calc(50% - " + -1 * this.left + "px)"),
                (this.left = 0);
            else if (this.left > e) {
  ...
  updateOverlay = {
    bar: function (t, e) {
      var n = void 0;
      "rect" !== t.nodeName &&
        ((n = t.getAttribute("transform")), (t = t.childNodes[0]));
        ...
        },
        {
          ...
          value: function () {
            ...
            this.independentWidth &&
              (t.styles = { width: this.independentWidth + "px" }),
        ...
        },
        {
          ...
          value: function () {
            ...
            this.legendTotals.map(function (a, r) {
              var s = 110,
                o = Math.floor((t.width - getExtraWidth(t.measures)) / s);
              t.legendTotals.length < o &&
                (s = t.width / t.legendTotals.length),
                n > o && ((n = 0), (i += 20));
              var l = legendDot(
                s * n + 5,
                i,
      ...
      animateElements: function (t) {
        ...
        return (
          this.store.map(function (a, r) {
            y = y.concat(
              animateBar(a, e[r], n[r], t.barWidth, i[r], {
                zeroLine: t.zeroLine,
              })
            );
          }),
      ...
      animateElements: function (t) {
        ...
        return (
          Object.keys(this.paths).length &&
            (f = f.concat(
              animatePath(this.paths, e, n, t.zeroLine, this.constants.spline)
            )),
          this.units.length &&
      ...
      _createClass(e, [
        {
          ...
          value: function (t) {
            ...
            (n.height = n.height || PERCENTAGE_BAR_DEFAULT_HEIGHT),
              (n.depth = n.depth || PERCENTAGE_BAR_DEFAULT_DEPTH),
              (e.paddings.right = 30),
              (e.legendHeight = 60),
              (e.baseHeight = 8 * (n.height + 0.5 * n.depth));
          },
        },
        {
          key: "setupComponents",
        ...
        { key: "makeDataByIndex", value: function () {} },
        {
          ...
          value: function () {
            ...
            this.container.addEventListener("mousemove", function (n) {
              ...
              if (i.includes(a)) {
                var r = i.indexOf(a),
                  s = getOffset(t.container),
                  o = getOffset(a),
                  l = o.left - s.left + parseInt(a.getAttribute("width")) / 2,
                  u = o.top - s.top,
                  c =
  ...
  PieChart = (function (t) {
    function e(t, n) {
      ...
      var i = _possibleConstructorReturn$2(
        this,
        (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)
      );
      ...
      _createClass$5(e, [
        ...
        },
        {
          ...
          value: function () {
            ...
            n.sliceTotals.map(function (e, o) {
              var l = s,
                ...
                y = void 0;
              t.init
                ? ((g = v ? v.startPosition : f), (y = v ? v.endPosition : f))
                : ((g = f), (y = p));
              var m =
                360 === u
                  ? makeCircleStr(g, y, t.center, t.radius, a, c)
                  : makeArcPathStr(g, y, t.center, t.radius, a, c);
              n.sliceStrings.push(m),
                n.slicesProperties.push({
                  startPosition: f,
                  endPosition: p,
                  value: e,
                  total: n.grandTotal,
          ...
          value: function (t, e, n, i) {
            if (t) {
              ...
              if (n) {
                transform(
                  t,
                  this.calTranslateByAngle(this.state.slicesProperties[e])
                ),
                  (t.style.fill = lightenDarkenColor(a, 50));
                var r = getOffset(this.svg),
                  ...
                  l =
                    (this.formatted_labels && this.formatted_labels.length > 0
                      ...
                      : this.state.labels[e]) + ": ",
                  u = (
                    (100 * this.state.sliceTotals[e]) /
                    this.state.grandTotal
                  ).toFixed(1);
                this.tip.setValues(s, o, { name: l, value: u + "%" }),
                  this.tip.showTip();
              } else
                transform(t, "translate3d(0,0,0)"),
                  this.tip.hideTip(),
                  (t.style.fill = a);
            }
          },
          ...
          value: function (t) {
            ...
            if (n.includes(e)) {
              ...
              this.hoverSlice(a, i, !1),
                ...
                (this.curActiveSliceIndex = r),
                this.hoverSlice(e, r, !0, t);
  ...
  Heatmap = (function (t) {
    function e(t, n) {
      ...
      var i = _possibleConstructorReturn$3(
        this,
        (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)
      );
      ...
      _createClass$6(e, [
        {
          ...
          value: function (t) {
            ...
            (this.discreteDomains = 0 === t.discreteDomains ? 0 : 1),
              (e.paddings.top = 3 * ROW_HEIGHT),
              (e.paddings.bottom = 0),
              (e.legendHeight = 2 * ROW_HEIGHT),
              (e.baseHeight =
                ROW_HEIGHT * NO_OF_DAYS_IN_WEEK + getExtraHeight(e));
            var n = this.data,
              i = this.discreteDomains ? NO_OF_YEAR_MONTHS : 0;
            this.independentWidth =
              (getWeeksBetween(n.start, n.end) + i) * COL_WIDTH +
              getExtraWidth(e);
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            var t = this.state;
            (t.start = clone(this.data.start)),
              (t.end = clone(this.data.end)),
              (t.firstWeekStart = clone(t.start)),
              (t.noOfWeeks = getWeeksBetween(t.start, t.end)),
              (t.distribution = calcDistribution(
              ...
              t.components.forEach(function (n) {
                ...
                if (i.includes(a)) {
                  var r = a.getAttribute("data-value"),
                    s = a.getAttribute("data-date").split("-"),
                    o = getMonthName(parseInt(s[1]) - 1, !0),
        ...
        },
        {
          ...
          value: function () {
            ...
            var e = 0,
              n = ROW_HEIGHT,
              i = makeText("subdomain-name", e, n, "Less", {
                fontSize: HEATMAP_SQUARE_SIZE + 1,
                dy: 9,
              });
            (e = 2 * COL_WIDTH + COL_WIDTH / 2),
              this.legendArea.appendChild(i),
              this.colors
                .slice(0, HEATMAP_DISTRIBUTION_SIZE)
                .map(function (i, a) {
                  var r = heatSquare(
                    "heatmap-legend-unit",
                    e + (COL_WIDTH + 3) * a,
                  ...
                  t.legendArea.appendChild(r);
                });
            var a = makeText(
              "subdomain-name",
              e + HEATMAP_DISTRIBUTION_SIZE * (COL_WIDTH + 3) + COL_WIDTH / 4,
              n,
              "More",
        ...
        },
        {
          ...
          value: function () {
            for (
              ...
              var u = t.end;
              if (!areInSameMonth(o, t.end)) {
                var c = [o.getMonth(), o.getFullYear()];
                u = getLastDateInMonth(c[0], c[1]);
              }
              s.push(this.getDomainConfig(o, u)), addDays(u, 1), (o = u);
            }
            return s;
          },
        },
        {
          ...
          value: function (t) {
            ...
            for (
              var o = getWeeksBetween(r, e), l = [], u = void 0, c = 0;
              c < o;
              c++
            )
              (u = this.getCol(r, i)),
                l.push(u),
                addDays((r = new Date(u[NO_OF_DAYS_IN_WEEK - 1].yyyyMmDd)), 1);
            return (
              void 0 !== u[NO_OF_DAYS_IN_WEEK - 1].dataValue &&
                (addDays(r, 1), l.push(this.getCol(r, i, !0))),
              (s.cols = l),
              s
            );
          },
          ...
          value: function (t, e) {
            for (
              var n =
                ...
                r = [],
                s = 0;
              s < NO_OF_DAYS_IN_WEEK;
              s++, addDays(a, 1)
            ) {
              var o = {},
                l = a >= i.start && a <= i.end;
              n || a.getMonth() !== e || !l
                ? (o.yyyyMmDd = getYyyyMmDd(a))
  ...
  AxisChart = (function (t) {
    function e(t, n) {
      ...
      var i = _possibleConstructorReturn$4(
        this,
        (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)
      );
      return (
          ...
          value: function () {
            ...
            this.data.yMarkers &&
              (this.state.yMarkers = this.data.yMarkers.map(function (e) {
                return (
                  (e.position = scale(e.value, t.yAxis)),
                  e.options || (e.options = {}),
                  e
                );
              })),
          ...
          value: function () {
            ...
            this.overlayGuides &&
              ...
              this.overlayGuides.map(function (e) {
                ...
                (e.overlay = makeOverlay[e.type](n)),
  ...
  DonutChart = (function (t) {
    function e(t, n) {
      ...
      var i = _possibleConstructorReturn$5(
        this,
        (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n)
      );
      return (
        (i.type = "donut"), (i.initTimeout = 0), (i.init = 1), i.setup(), i
      );
    }
    return (
      _inherits$5(e, t),
            ...
            if (t) {
              ...
              if (n) {
                transform(
                  ...
                  (t.style.stroke = lightenDarkenColor(a, 50));
                var r = getOffset(this.svg),
                  s = i.pageX - r.left + 10,
                  o = i.pageY - r.top - 10,
                  l =
