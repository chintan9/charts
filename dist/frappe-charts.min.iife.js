var frappe = (function () {
  ...
  function R(t, e, i) {
    ...
    n.pos || (n.pos = "left"),
      n.offset || (n.offset = 0),
      n.mode || (n.mode = "span"),
      n.stroke || (n.stroke = ne),
      n.className || (n.className = "");
    var a = -1 * Zt,
      s = "span" === n.mode ? i + Zt : 0;
    return (
      "tick" === n.mode && "right" === n.pos && ((a = i + Zt), (s = i)),
      (a += n.offset),
      (s += n.offset),
      I(t, e, a, s, {
        stroke: n.stroke,
  ...
  function Y(t, e, i) {
    ...
    n.pos || (n.pos = "bottom"),
      ...
      n.className || (n.className = "");
    var a = i + Zt,
      s = "span" === n.mode ? -1 * Zt : i;
    return (
      "tick" === n.mode && "top" === n.pos && ((a = -1 * Zt), (s = 0)),
      F(t, e, a, s, {
        stroke: n.stroke,
        className: n.className,
        lineType: n.lineType,
  ...
  function Q(t, e, i, n) {
    ...
    return (
      ...
      "rect" !== t.nodeName
        ? [
            [t.childNodes[0], { width: n, height: o }, oe, ce],
            X(
              t,
        ...
        : [[t, { width: n, height: o, x: e, y: l }, oe, ce]]
    );
  }
  function Z(t, e, i) {
  ...
  function wt(t) {
    ...
    var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      n = Math.max.apply(Math, Rt(t)),
      a = Math.min.apply(Math, Rt(t)),
      s = [];
    if (n >= 0 && a >= 0) bt(n)[1], (s = i ? kt(n, a) : kt(n));
    else if (n > 0 && a < 0) {
      var r = Math.abs(a);
      n >= r
        ? (bt(n)[1], (s = e(n, r)))
      ...
      var o = Math.abs(a),
        l = Math.abs(n);
      bt(o)[1],
        (s = (s = i ? kt(o, l) : kt(o)).reverse().map(function (t) {
          return -1 * t;
        }));
    }
    return s;
  ...
  function Ct(t, e) {
    for (
      var i = Math.max.apply(Math, Rt(t)), n = 1 / (e - 1), a = [], s = 0;
      s < e;
      s++
    ) {
      var r = i * (n * s);
  ...
  var Yt = {
        ...
        Wt(e, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = [];
              return (
                (t = (t || []).concat(Xt[e])).forEach(function (t) {
                  var e = Qt(t);
                  x(e)
                    ? i.push(e)
    ...
    ve = (function (t) {
      function e(t, i) {
        return (
          zt(this, e),
          Ft(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
        );
      }
      return (
        jt(e, t),
        ...
        makeElements: function (t) {
          ...
          return (
            ...
            t.cols.map(function (t, i) {
              1 === i &&
                e.labels.push(
                  j("domain-name", o, -12, ft(n, !0).toUpperCase(), {
                    fontSize: 9,
                  })
                ),
                t.map(function (t, i) {
        ...
        animateElements: function (t) {
          ...
          return (
            this.store.map(function (a, s) {
              m = m.concat(
                Q(a, e[s], i[s], t.barWidth, n[s], { zeroLine: t.zeroLine })
              );
            }),
            m
          );
        ...
        animateElements: function (t) {
          ...
          return (
            Object.keys(this.paths).length &&
              (p = p.concat(
                tt(this.paths, e, i, t.zeroLine, this.constants.spline)
              )),
            this.units.length &&
        ...
        Wt(e, [
          ...
          },
          {
            ...
            value: function () {
              ...
              this.legendArea.textContent = "";
              var e = 0,
                i = j("subdomain-name", e, 12, "Less", { fontSize: 11, dy: 9 });
              (e = 30),
          ...
          },
          {
            ...
            value: function (t) {
              var e =
                ...
                r = { index: n, cols: [] };
              yt((e = ht(e) || vt(n, a)), 1);
              for (var o = ct(s, e), l = [], u = void 0, h = 0; h < o; h++)
                (u = this.getCol(s, n)),
                  l.push(u),
                  yt((s = new Date(u[ge - 1].yyyyMmDd)), 1);
              return (
                void 0 !== u[ge - 1].dataValue &&
                  (yt(s, 1), l.push(this.getCol(s, n, !0))),
                (r.cols = l),
                r
              );
            },
          ...
          },
          {
            ...
            value: function () {
              ...
              e.sliceTotals.map(function (i, o) {
                ...
                var b =
                  360 === u
                    ? S(y, m, t.center, t.radius, t.clockWise, h)
